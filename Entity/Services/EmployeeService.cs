...
public class EmployeeService : IEmployeeService
{
    ...
    public async Task<ResponseEntity> GetEmployeeById(int id)
    {
        try
        {
            ...
            return new ResponseEntity(StatusCodeConstants.Ok, employee, MessageConstants.Success);
        }
        catch (Exception ex)
        {
    ...
    public async Task<ResponseEntity> GetAllEmployee(string keyWord = "")
    {
        ...
        return new ResponseEntity(StatusCodeConstants.Ok, employees, MessageConstants.Success);
    }
    ...
    public async Task<ResponseEntity> InsertEmployee(EmployeeViewModel model)
    {
        try
        {
            ...
            return new ResponseEntity(StatusCodeConstants.Ok, employee, MessageConstants.InsertSuccess);
        }
        catch (Exception ex)
        {
    ...
    public async Task<ResponseEntity> UpdateEmployee(EmployeeViewModel model)
    {
        try
        {
            ...
            return new ResponseEntity(StatusCodeConstants.Ok, employee, MessageConstants.UpdateSuccess);
        }
        catch (Exception ex)
        {
            return new ResponseEntity(StatusCodeConstants.BadRequest, ex.Message, MessageConstants.InsertFailure);
    ...
    public async Task<ResponseEntity> DeleteEmployee(int id)
    {
        try
        {
            ...
            return new ResponseEntity(StatusCodeConstants.Ok, employee, MessageConstants.DeleteSuccess);
        }
        catch (Exception ex)
        {
